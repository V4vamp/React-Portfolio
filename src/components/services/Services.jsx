					...
					<div
						...
						<div className='services__modal-content'>
							...
							<p className='services__modal-description'>
								Service with approximately 1 year of experience. providing quality full stack
				...
				<div className='services__content'>
					...
					<div
						...
						<div className='services__modal-content'>
							...
							<p className='services__modal-description'>
								Service with approximately 1 year of experience. providing quality server
								side applications to clients.
							</p>
				...
				<div className='services__content'>
					...
					<div
						...
						<div className='services__modal-content'>
							...
							<p className='services__modal-description'>
								Service with approximately year 1 of experience. Providing quality Client
								side applications to clients.
							</p>
